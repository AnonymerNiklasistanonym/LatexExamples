...
\begin{figure}[H]
	...
	\caption{Bild \texttt{[H]} welches zu groß ist für die aktuelle Seite, aber den folgenden Inhalt blockiert, im Gegensatz zum Standardverhalten, welcher diesen schon auf der vorherigen Seite platzieren würde}
